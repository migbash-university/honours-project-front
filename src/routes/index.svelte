...
<section>
    ...
    <div 
        ...
        <!-- ... warning-headline-honours-project ... -->
        <span 
            ...
            />
            <p 
                class='s-14 color-secondary'>
                <b>THIS IS AN HONOURS PROJECT</b>
            </p>
        </span>
        
        <!-- ... warning-headline-ethics ... -->
        <p 
            class='s-14 m-b-25 bold'> 
...
<style>
    ...
    label#terms-and-agreement-checkbox {
