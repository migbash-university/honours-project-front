export const planet_markers = [
  {
    ...
    info: {
        ...
        description: `The surface of Titan is one of the most Earthlike places in the solar system, albeit at vastly colder temperatures and with different chemistry.`,
        description_3: `The surface of Titan is one of the most Earthlike places in the solar system, albeit at vastly colder temperatures and with different chemistry. Here it is so cold (-290 degrees 
  ...
  ,
  {
    ...
    info: {
        ...
        description_3: `Our solar system is home to more than 150 moons, but Titan is unique in being the only moon with a thick atmosphere. At the surface of Titan, the atmospheric pressure is about 60 percent 
  ...
  {
    // ... Marker_3
    // ... gravitational-pull information;
    // ... #gravity-info
    id: '3',
    label_name: 'Gravity',
    ...
    info: {
        ...
        description_3: `The surface gravity on Mars is only about 38% of the surface gravity on Earth, so if you weigh 100 pounds on Earth, you would weigh only 38 pounds on Mars. 
  ...
  ,
  {
    ...
    // ... rel #orbit-and-rotation-text
    id: '4',
    label_name: 'Orbit',
    coord: [ 23.524167, 100.650833 ],
    target_text: 'orbit-and-rotation-text',
    info: {
        icon_img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Kennedy_Space_Center_composite_photograph.jpg/450px-Kennedy_Space_Center_composite_photograph.jpg',
        ...
        description_3: `Titan takes 15 days and 22 hours to complete a full orbit of Saturn. Titan is also tidally locked in synchronous rotation with Saturn, meaning that, 
  ...
  {
    // ... Marker_5
    // ... formation speed information;
    // ... rel #formation-text
    id: '5',
    label_name: 'Formation',
    coord: [ -23.524167, -100.650833 ],
    ...
    info: {
        ...
        description_3: `Scientists aren’t certain about Titan’s origin. However, its atmosphere provides a clue. Several instruments on the NASA and ESA Cassini-Huygens mission measured the isotopes 
  ...
  ,
  {
    ...
    // ... rel #formation-text
    id: '7',
    label_name: 'Potential Life',
    coord: [ 53.524167, 75.650833 ],
    target_text: 'potential-text',
    info: {
        icon_img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Kennedy_Space_Center_composite_photograph.jpg/450px-Kennedy_Space_Center_composite_photograph.jpg',
        description: `Titan could potentially harbor environments with conditions suitable for life—meaning both life as we know it (in the subsurface ocean).`,
        description_3: `The Cassini spacecraft’s numerous gravity measurements of Titan revealed that the moon is hiding an underground ocean of liquid water (likely mixed with salts and ammonia). 
